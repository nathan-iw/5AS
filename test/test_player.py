...
class PlayerTests(unittest.TestCase):
    ...
    def test_player_unable_to_play(self):
        # Arrange
        expected_outcome = "Gary McTest, male, age 7, both-footed and currently unable to play."
    ...
    def test_player_able_to_play(self):
        # Arrange
        expected_outcome = "Gary McTest, male, age 7, both-footed and currently able to play."
